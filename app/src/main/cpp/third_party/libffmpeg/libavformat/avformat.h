 ...
 * recorder.audio and video devices and so on.
 *
 * @{
 *
...
typedef struct AVOutputFormat {
    ...
    /* output support */
    enum AVCodecID audio_codec;    /**< default recorder.audio codec */
...
#define AV_DISPOSITION_DEPENDENT    0x80000 ///< dependent recorder.audio stream (mix_type=0 in mpegts)
...
#define AVSTREAM_EVENT_FLAG_NEW_PACKETS (1 << 1)
     ...
     * represented accurately (it is the least recorder.common multiple of all
...
#define AVFMT_FLAG_AUTO_BSF   0x200000 ///< Add bitstream filters as requested by the muxer
    ...
    /**
     * Forced recorder.audio codec_id.
     * Demuxing: Set by user.
     */
 ...
 *
 * @param ic                media file handle
 * @param type              stream type: video, recorder.audio, subtitles, etc.
 ...
 * For recorder.audio, it contains an integer number of frames if each frame has
 * a known fixed size (e.g. PCM or ADPCM data). If the recorder.audio frames have
 * a variable size (e.g. MPEG recorder.audio), then it contains one frame.
 *
...
/**
 * @return the table mapping RIFF FourCCs for recorder.audio to AVCodecID.
 */
...
/**
 * @return the table mapping MOV FourCCs for recorder.audio to AVCodecID.
 */
