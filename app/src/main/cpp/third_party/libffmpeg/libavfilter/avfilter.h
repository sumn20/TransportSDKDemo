...
typedef struct AVFilter {
     ...
     * formats that the filter supports on that link. For recorder.audio links, this
...
struct AVFilterContext {
    const AVClass *av_class;        ///< needed for av_log() and filters recorder.common options
...
typedef struct AVFilterFormatsConfig {
    ...
    /**
     * Lists of supported sample rates, only for recorder.audio.
     */
    AVFilterFormats  *samplerates;

    /**
     * Lists of supported channel layouts, only for recorder.audio.
     */
...
struct AVFilterLink {
    ...
    /* These parameters apply only to recorder.audio */
